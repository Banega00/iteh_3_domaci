        ...
        <div>
            {gameDetails ?
                <div className="bg-black">
                    ...
                    <div className="text-3xl text-white relative z-10 text-center font-semibold">Released: {gameDetails.released}</div>
                    <div className=" bg-green-800/[.6] relative text-white p-4 w-[50vw] min-w-[600px] mx-auto">
                        ...
                        <div className="pb-2 text-sm my-2 border-b-2 border-white">
                            Available on {gameDetails.platforms.map((element: any, index: number) => <span>{element.platform.name}{gameDetails.platforms.length - 1 !== index ? ',' : ''} </span>)}
                        </div>
                        <div className="pb-2 text-sm my-2 border-b-2 border-white">
                        ...
                        {gameDetails.screenshots.map((screenshot: any) => <div className="pb-2 text-sm my-2 border-b-2 border-white"><img src={screenshot.image} alt="" /></div>)}
                    </div>
                </div> : ''
            }
